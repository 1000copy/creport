...
begin
  result  :=
    FtopMargin + nHandHeight + nDataHeight + nHootHeight + FBottomMargin
    >
    height
end;
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      If (Faddspace) And ((i = TempDataSetCount) And (not IsPageFull)) Then
      Begin
      ...
      If IsLastPageFull Or (i = TempDataSetCount) Then
      Begin
