...
type
  ...
  Private
    ...
    Procedure SaveTempFile(FLineList:TList;FileName:string;PageNumber, Fpageall: Integer);
...
Begin
  ...
  Begin
    ...
    UpdatePrintLines;
    If saveyn Then
      SaveTempFile( FPrintLineList,ReadyFileName(fpagecount, Fpageall),fpagecount, FpageAll);
  End else
  Begin
